...
const developer: Developer = {
  ...
  openTo: ["Open-source collabs", "Cool projects", "Hiring"],
  funFact: "I debug in production more often than I'd admit 😅",
};

export default developer; // ready to build with you
```
